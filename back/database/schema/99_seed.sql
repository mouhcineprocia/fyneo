...
INSERT INTO public.organization (id, name, legal_name, plan, status)
VALUES (
...
-- Password: Fyneo@2024!
-- Hash generated with pgcrypto blowfish (compatible with bcryptjs.compare)
...
VALUES (
  ...
  'El Fellahi',
  'mouhcine@winu.fr',
  crypt('Fyneo@2024!', gen_salt('bf', 10)),
  'superAdmin',
  true,
  true
...
-- ============================================================
-- agent_onboarding seed data — org 00000000-0000-0000-0000-000000000001
-- ============================================================
...
-- KPIs
INSERT INTO public.agent_onboarding (organization_id, date, entry_type, kpi_key, kpi_value, kpi_sub, sort_order) VALUES
...
-- Alerts
INSERT INTO public.agent_onboarding (organization_id, date, entry_type, alert_type, title, message, time_of_event, dossier_name, sort_order) VALUES
...
-- Priorities
INSERT INTO public.agent_onboarding (organization_id, date, entry_type, urgency, action_type, title, description, dossier_name, deadline, sort_order) VALUES
...
-- Timeline
INSERT INTO public.agent_onboarding (organization_id, date, entry_type, alert_type, title, description, time_of_event, sort_order) VALUES
...
-- Activities
INSERT INTO public.agent_onboarding (organization_id, date, entry_type, action, entity_type, dossier_name, time_of_event, sort_order) VALUES
...
-- Docs pending
INSERT INTO public.agent_onboarding (organization_id, date, entry_type, alert_type, title, description, dossier_name, sort_order) VALUES
...
-- Planned tasks
INSERT INTO public.agent_onboarding (organization_id, date, entry_type, title, day_label, task_color, sort_order) VALUES
...
-- ┌─────────────────────────────────────────────────────────────┐
-- │  DATE: 2026-05-05  (2 days ago — maintenance window)        │
-- └─────────────────────────────────────────────────────────────┘
